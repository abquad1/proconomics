  ...
  return (
    <footer className='w-full relative'>
        <section className="w-full flex flex-col relative">
            {/* Newsletter */}
            <div className="mx-4 md:mx-12 shadow-lg my-10 rounded-2xl p-4 md:p-16 bg-white flex flex-col md:flex-row justify-between items-start gap-10 relative z-10">
            ...
            <section className="w-full bg-black py-10 mt-[-20%] ">
                <div className='grid grid-cols-2 md:flex md:flex-row pt-[20%] px-4 md:px-12 justify-between gap-16 md:gap-48 mx-auto max-w-7xl '>
                    ...
                    {/* horizontal line below the foorer links */}
                <div className="bg-white h-[0.5px] mx-4 md:mx-12 my-8"></div>

                <section className='flex justify-between items-center px-4 md:px-12'>
